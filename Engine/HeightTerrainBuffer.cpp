...
HeightTerrainBuffer::HeightTerrainBuffer()
{
}

HeightTerrainBuffer::HeightTerrainBuffer(const HeightTerrainBuffer & Rhs)
{
}
...
HRESULT HeightTerrainBuffer::Initialize(int _terrainWidth, int _terrainHeight, wstring _heightMapPath)
{
	...
	{
		MSG_BOX("Failed to initial buffer for HeightTerrainBuffer.");
		return E_FAIL;
	}
...
HRESULT HeightTerrainBuffer::InitializeBuffer()
{
	VertexType* vertices;
...
HRESULT HeightTerrainBuffer::LoadHeightMap(wstring _heightMapPath)
{
	int error, imageSize;
	int i, j, k, index;
	FILE* filePtr;
...
void HeightTerrainBuffer::SetTerrainCoordinates()
{
	int i, j, index;
...
HRESULT HeightTerrainBuffer::BuildTerrainModel()
{
...
HRESULT HeightTerrainBuffer::CalculateNormal()
{
...
void HeightTerrainBuffer::RenderBuffers()
{
...
void HeightTerrainBuffer::Render()
{
	RenderBuffers();
}

shared_ptr<HeightTerrainBuffer> HeightTerrainBuffer::Create(int _terrainWidth, int _terrainHeight, wstring _heightMapPath)
{
	shared_ptr<HeightTerrainBuffer> Instance(new HeightTerrainBuffer());
	if (FAILED(Instance->Initialize(_terrainWidth, _terrainHeight, _heightMapPath)))
	{
		MSG_BOX("Failed to create HeightTerrainBuffer.");
		return nullptr;
	}
